...
interface FeatureSection {
  title: string;
  subtitle: string;
  // Pour la mise en page en cartes (ex: Puissance, Pneu)
  items?: {
    image: string;
    description: string;
  }[];
...
const ShowcasePage: React.FC = () => {
  ...
  // --- Données pour la section Puissance ---
  ...
  return (
    <div className="w-full bg-gray-100">
      ...
      <main className="w-full">
        ...
        {/* --- SECTION TECHNIQUE (FICHE TECHNIQUE, PUISSANCE ET PNEU) --- */}
